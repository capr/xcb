--xcb/xcb.h and xcb/xproto.h from libxcb1-dev package v1.10-2ubuntu1 from ubuntu 14

local ffi = require'ffi'

ffi.cdef[[
// because the API needs it
void free(void*);

// xcb/xcb.h (structs only, functions at the bottom)
enum {
	X_PROTOCOL           = 11,
